#!/usr/bin/env sh
# Universal installer for compliance-atlas. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/compliance-atlas.git"
echo "Installing compliance-atlas ..."
...
echo "Done. Run: compliance-atlas --help"
